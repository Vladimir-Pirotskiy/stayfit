...
export default function AddBusinessModal({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-50 backdrop-blur-sm">
      <div className="bg-gradient-to-r from-gray-800 via-gray-700 to-gray-800 w-full max-w-lg rounded-lg shadow-lg">
        ...
        <form className="p-4" onSubmit={handleSubmit(onSubmit)}>
          <div className="mb-4">
            ...
            <input
              ...
              className={`w-full px-4 py-2 border border-gray-600 bg-gray-900 text-gray-100 rounded-lg focus:outline-none focus:border-blue-500 ${errors.category ? 'border-red-500' : ''}`}
